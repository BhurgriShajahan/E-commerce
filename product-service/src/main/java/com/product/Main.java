...
public class Main {
    ...
    // This is class for Decrypt to Encrypt and Encrypt to Decrypt test ...
    ...
    public static void main(String[] args) {
        try {
            String combinedEncryptedMessage = "Arslan@1234";
            String encrypt = encrypt(combinedEncryptedMessage);
            String decrypt = decrypt("WwvGOzflZ3UBMgoz823+0w==:As18FFAqre9WUvttAB3dBA==:WnboEoNdRNCnA8jrKwav0cEy+YzdGh0HKpsDmmkED8U=");
